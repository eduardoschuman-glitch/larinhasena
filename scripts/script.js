...
(function () {
  ...
  var services = [
    ...
    { id: 'hidra', name: 'Hidragloss', images: ['assets/cat/hidra-depois.jpg', 'assets/cat/hidra-antes.jpg'],
    ...
    { id: 'color', name: 'Coloração de Sobrancelhas', images: ['assets/cat/color-depois.jpg', 'assets/cat/color-antes.jpg'],
    ...
    { id: 'design', name: 'Design de Sobrancelhas', images: ['assets/cat/design.jpg'],
    ...
    { id: 'epilacao', name: 'Epilação Egípcia', images: ['assets/cat/epilacao-depois.jpg', 'assets/cat/epilacao-antes.jpg'],
    ...
    { id: 'microlip', name: 'Micropigmentação Labial', images: ['assets/cat/microlip-2.jpg', 'assets/cat/microlip-1.jpg', 'assets/cat/microlip-3.jpg'],
